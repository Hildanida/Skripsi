...
from api import object_counting_api_coba
import numpy as np
import cv2
import os
from playsound import playsound
import threading 
from api.object_counting_api_coba import targeted_object_counting
...
while True:
    ...
    object_counting_api_coba.targeted_object_counting(input_video, detection_graph, category_index, is_color_recognition_enabled, targeted_objects, fps, width, height) # targeted objects counting
